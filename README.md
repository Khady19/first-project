# j'ai créer un projet CALCULATOR qui permet de faire l'addition de deux nombre le projet se présente comme suite
...
# Apres je me suis connecetr à sonarcloud avec mon compte github 
